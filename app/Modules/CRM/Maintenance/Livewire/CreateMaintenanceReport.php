...
class CreateMaintenanceReport extends Component
{
    ...
    // 5. Plugins (dynamic array)
    public array $plugins = []; // array of ['plugin_name' => '', 'old_version' => '', 'new_version' => '', 'status' => 'updated', 'notes' => '']
    ...
    public function render()
    {
        ...
        $developers = User::whereHas('admin')->orderBy('name')->get();

        return view('modules.crm.maintenance.create-maintenance-report', [
            'clients' => $clients,
            'websites' => $websites,
