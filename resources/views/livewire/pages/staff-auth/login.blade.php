    ...
    <form wire:submit="login" class="space-y-5">
        ...
        <div>
            <button type="submit" wire:loading.attr="disabled" class="disabled:opacity-75 disabled:cursor-not-allowed w-full mt-2 py-3.5 px-4 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 active:scale-95 text-white font-bold text-sm rounded-xl shadow-lg shadow-indigo-500/15 hover:shadow-indigo-500/25 transition duration-150 cursor-pointer flex items-center justify-center space-x-2">
                ...
                <span wire:loading.remove wire:target="login">Staff Sign In</span>
                <span wire:loading wire:target="login">Signing In...</span>
                <svg wire:loading.remove wire:target="login" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
