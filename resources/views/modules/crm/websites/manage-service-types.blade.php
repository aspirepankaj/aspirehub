        ...
        <div class="space-y-4 mt-2">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200/40 dark:border-slate-800/30">
                <button type="button" @click="$dispatch('close-modal', { name: 'add-service-type-modal' })"
                        class="px-4 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-xs rounded-xl border border-slate-200/50 dark:border-slate-800/50 active:scale-95 transition duration-150">
                    Cancel
                </button>
                <x-admin.button type="button" wire:click="saveType" size="sm" variant="primary">
                    Create Type
                </x-admin.button>
            </div>
        </div>
    ...
    <x-admin.modal name="edit-service-type-modal" title="Edit Service Type">
        <div class="space-y-4 mt-2">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200/40 dark:border-slate-800/30">
                ...
                <x-admin.button type="button" wire:click="updateType" size="sm" variant="primary">
                    Update Type
                </x-admin.button>
            </div>
        </div>
