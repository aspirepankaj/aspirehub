...
<div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <button type="button" 
                ...
                class="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-gradient-to-r from-pink-500 to-indigo-650 hover:from-pink-650 hover:to-indigo-750 text-white text-xs font-bold transition-all duration-150 active:scale-95 shadow-sm">
