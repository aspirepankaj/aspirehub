...
<div>
    ...
    <form wire:submit.prevent="updateReport" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input wire:model="maintenance_date" type="date"
                           class="block mt-1.5 w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-100 text-sm focus:outline-none" />
        ...
        <x-admin.card>
            ...
            {{-- Upload New files --}}
            <div>
                <label class="block text-[10px] font-extrabold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5">Upload New Attachments</label>
                <input type="file" wire:model="newAttachments" multiple class="block text-xs text-slate-500 dark:text-slate-400 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-indigo-50 dark:file:bg-indigo-950/20 file:text-indigo-600 dark:file:text-indigo-400 file:cursor-pointer" />
                <div wire:loading wire:target="newAttachments" class="text-xs text-indigo-500 font-bold mt-2">Uploading files...</div>
