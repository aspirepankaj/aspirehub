            ...
            <div class="flex items-center gap-3 justify-end">
                <div class="relative flex items-center min-w-[140px]">
                    ...
                    <select wire:model.live="perPage"
                            class="block w-full pl-9 pr-8 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/50 dark:border-slate-700/50 text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400 text-sm transition duration-150 appearance-none cursor-pointer">
        ...
        <div class="mt-2 flex flex-col gap-3">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200/40 dark:border-slate-800/30">
                ...
                <button type="button" wire:click="saveDesignation"
                    ...
                    <svg wire:loading wire:target="saveDesignation" class="animate-spin h-4 w-4 text-white mr-1.5" fill="none" viewBox="0 0 24 24">
        ...
        <div class="mt-2 flex flex-col gap-3">
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200/40 dark:border-slate-800/30">
                ...
                <button type="button" wire:click="updateDesignation"
                        style="background: linear-gradient(90deg, #105166 0%, #529daa 100%);"
                        class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-white text-xs font-bold shadow-lg transition-all duration-300 active:scale-95 whitespace-nowrap">
                    <svg wire:loading wire:target="updateDesignation" class="animate-spin h-4 w-4 text-white mr-1.5" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
