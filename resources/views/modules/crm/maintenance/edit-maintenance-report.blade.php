...
<div>
    {{-- Breadcrumbs --}}
    <x-admin.breadcrumbs :items="['Maintenance Reports' => route('admin.maintenance'), 'Edit Report #' . $reportId => null]" />
                            ...
                            <div class="flex flex-col gap-2 p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50">
                                ...
                                <div class="flex items-center justify-between gap-2 mt-1">
                                    ...
                                    <button type="button" wire:click="deleteAttachment({{ $att['id'] }})"
                                            ...
                                            class="text-xs font-bold text-red-500 hover:text-red-600 transition shrink-0">
                                        Delete
                                    </button>
                                </div>
                            </div>
