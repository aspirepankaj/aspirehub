                            ...
                            <div class="flex items-center justify-between p-5 border-b border-slate-100 dark:border-slate-800/60 rounded-t-3xl sticky top-0 bg-white dark:bg-slate-900 z-10">
                                <div>
                                    <h3 class="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                                        ...
                                        {{ $activeReportIntegrationId === 'gsc' ? 'Google Search Console - Detailed Report' : 'Google Analytics 4 - Detailed Report' }}
                                    </h3>
    ...
    @else
        ...
        <div class="flex items-center justify-between gap-4 mb-5">
            ...
            <div class="flex items-center gap-2">
                ...
                {{-- Add Client button --}}
                <button type="button" @click="$dispatch('open-modal', { name: 'add-client-modal' })"
